...
namespace spritelib
{
	...
	public:
		...
		*/
		//Sprite& set_sprite_frame_size(math::Vector3 a_size, bool a_setScale = true);
		/* push_frame_row
		...
		*/
		...
		/* push_frame_row
			- animationID is a string that you use to set which animation you're using later on
			- start is a Vector3 of the coordinates of the very first frame
			- spacing is a Vector3 of the pixel offsets in between each frame
			- numFrames are the number of frames in the row you're adding
		*/
		//Sprite& push_frame_row(std::string a_animationID, math::Vector3 a_start,
		//	math::Vector3 a_spacing, unsigned int a_numFrames);
		/* push_frame
			- animationID is a string that you use to set which animation you're using later on
		...
		*/
		//Sprite& push_frame(std::string a_animationID, math::Vector3 a_pos);
		/* pop_frame
		...
		*/
		...
		/* set_center
		- center is a Vector3 with the coordinates of the pivot, from 0-1
		*/
		//Sprite& set_center(math::Vector3 a_center);
		/* next_frame
		...
		*/
		...
		/* set_position
			- pos is a Vetor3 with the coordinates on the screen where the sprite will be (from the center)
		*/
		Sprite& set_position(math::Vector3 a_pos);
		/* set_scale
		...
		*/
		//Sprite& set_scale(math::Vector3 a_height);
		/* set_rotation
		...
		*/
		//template<class T>static void Sort(std::vector<T*>& a_sprites);
