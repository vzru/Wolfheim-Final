...
namespace spritelib
{
	...
	*/
	...
	void Shapes::ShapesShader::init_shader()
	{
		...
		s_vert->load_shader(Shader::VERTEX, "assets/shaders/BlankVert.glsl")
			.compile_shader();

		s_geom->load_shader(Shader::GEOMETRY, "assets/shaders/FilledCircleGeom.glsl")
			.compile_shader();

		s_geom2->load_shader(Shader::GEOMETRY, "assets/shaders/LineShaderGeom.glsl")
			.compile_shader();

		s_geom3->load_shader(Shader::GEOMETRY, "assets/shaders/FilledTriangleGeom.glsl")
			.compile_shader();

		s_frag->load_shader(Shader::FRAGMENT, "assets/shaders/ShapeFrag.glsl")
			.compile_shader();
